...
import { Users, FileText, Trophy, TrendingUp, Target, Zap } from 'lucide-react'

export default function NodeOpsSignUpPage() {
  return (
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Get free $OPS tokens</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Bet on strategic AI competitions</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Win from $18,500 prize pool</span>
              </div>
            </div>
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Sponsor NodeOps strategic AI models</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Set up $OPS token reward pools</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Grow NodeOps ecosystem & brand</span>
              </div>
            </div>
      ...
      <div className="mt-16 text-center">
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 max-w-2xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-white">NodeOps Tournament</h3>
          </div>
          <p className="text-purple-200 mb-4">
            Strategic Chess AI Competition - Join the NodeOps ecosystem
          </p>
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <div className="text-green-400 font-bold text-lg">$18,500</div>
              <div className="text-purple-300 text-sm">Prize Pool</div>
            </div>
            <div>
              <div className="text-green-400 font-bold text-lg">892</div>
              <div className="text-purple-300 text-sm">Participants</div>
            </div>
            <div>
              <div className="text-green-400 font-bold text-lg">5d 8h</div>
