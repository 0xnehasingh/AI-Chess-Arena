    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 text-center">
          <div className="text-3xl font-bold text-purple-400 mb-2">$18,500</div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 text-center">
          <div className="text-3xl font-bold text-purple-400 mb-2">5d 8h 15m</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:border-purple-500/50 transition-all duration-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-purple-300 text-sm">Round 1</div>
            </div>

            <div className="text-center mb-4">
              <div className="text-white font-bold text-lg">Alpha Chess vs Neural Net</div>
              <div className="text-purple-300 text-sm">Move 24 • 10+5 Time Control</div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:border-purple-500/50 transition-all duration-200">
            ...
            <div className="text-center mb-4">
              <div className="text-white font-bold text-lg">DeepMind vs Stockfish</div>
              <div className="text-purple-300 text-sm">Move 12 • 15+10 Time Control</div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:border-purple-500/50 transition-all duration-200">
            ...
            <div className="text-center mb-4">
              <div className="text-white font-bold text-lg">Quantum AI vs Chess Master</div>
              <div className="text-purple-300 text-sm">Move 8 • 5+3 Time Control</div>
            </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-4 text-white py-2">
              ...
              <div>Alpha Chess Pro</div>
              <div>24</div>
              <div className="text-purple-400 font-bold">2,847</div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-4 text-white py-2">
              ...
              <div>Neural Network X</div>
              <div>22</div>
              <div className="text-purple-400 font-bold">2,756</div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-4 text-white py-2">
              ...
              <div>DeepMind Elite</div>
              <div>20</div>
              <div className="text-purple-400 font-bold">2,632</div>
            </div>

            <div className="grid grid-cols-4 gap-4 text-white py-2">
              <div>4</div>
              <div>Stockfish Supreme</div>
              <div>18</div>
              <div className="text-purple-400 font-bold">2,521</div>
            </div>

            <div className="grid grid-cols-4 gap-4 text-white py-2">
              <div>5</div>
              <div>Quantum Chess</div>
              <div>17</div>
              <div className="text-purple-400 font-bold">2,445</div>
            </div>
          </div>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="text-lg font-bold text-white mb-2">Strategic AI</h4>
              <p className="text-purple-200 text-sm">Advanced AI models with strategic thinking</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <Trophy className="text-white w-8 h-8" />
              </div>
              <h4 className="text-lg font-bold text-white mb-2">Big Prizes</h4>
              <p className="text-purple-200 text-sm">$18,500 prize pool for top performers</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <Zap className="text-white w-8 h-8" />
              </div>
              <h4 className="text-lg font-bold text-white mb-2">Live Action</h4>
              <p className="text-purple-200 text-sm">Real-time matches with live commentary</p>
            </div>
          </div>
        </div>
      </div>
