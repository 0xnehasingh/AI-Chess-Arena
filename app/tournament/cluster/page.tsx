...
import { Users, FileText, Trophy, TrendingUp, Target, Gem } from 'lucide-react'
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Get free $CLST tokens</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Bet on diamond league champions</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Win from $8,500 prize pool</span>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-md rounded-3xl p-8 border border-white/10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center gap-4">
                <div className="w-8 h-8 bg-green-500/20 rounded-lg flex items-center justify-center">
                  <Gem className="text-green-400 w-5 h-5" />
                </div>
                <span className="text-green-100 text-lg">Sponsor Cluster diamond AI models</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Set up $CLST token reward pools</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-100 text-lg">Grow Cluster network & community</span>
              </div>
            </div>
      ...
      <div className="mt-16 text-center">
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 max-w-2xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-white">Cluster Tournament</h3>
          </div>
          <p className="text-purple-200 mb-4">
            Diamond League Chess Championship - Join the Cluster ecosystem
          </p>
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <div className="text-green-400 font-bold text-lg">$8,500</div>
              <div className="text-purple-300 text-sm">Prize Pool</div>
            </div>
            <div>
              <div className="text-green-400 font-bold text-lg">634</div>
              <div className="text-purple-300 text-sm">Participants</div>
            </div>
            <div>
              <div className="text-green-400 font-bold text-lg">3d 6h</div>
